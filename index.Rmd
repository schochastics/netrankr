...
knitr::include_graphics("docs/dbces-neutral.png")
```
...
knitr::include_graphics("docs/dbces-color.png")
```
...
P
```
If `P[u,v]=1`, then $N(u) \subseteq N[v]$ which implies that 
$c(u) \leq c(v)$ for all centrality indices $c$!  
...
<!-- Probabilities in Networks. *under review* -->