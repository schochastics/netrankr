rank_analysis_slow=function(P,method="bfs",names="",print.level=0){
  #' @title Rank Analysis of networks 
  #' @description  OBSOLETE AND ONLY HERE FOR TESTING.
  #' Performes a complete Rank analysis of a network.
