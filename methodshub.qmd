...
Sample data for all methods is available for testing. An example use case can be found [here](https://schochastics.github.io/netrankr/articles/use_case.html).
...
See the official [CRAN page](https://doi.org/10.32614/CRAN.package.netrankr) for further information about technical details.
