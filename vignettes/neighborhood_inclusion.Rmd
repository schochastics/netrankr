...
partial ranking on the vertices of a network. That is, (usually) some pairs of 
...
Very informally, if $u$ is dominated by $v$, then u is **always** less central 
than $v$ no matter which centrality index is used. 
