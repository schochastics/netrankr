...
$$
holds for most indices, betweenness fails to fulfil this property.  
\
The intervals reduce to single points for [threshold graphs](threshold_graph.html), 
since all nodes are pairwise comparable bei neighborhood-inclusion.
```{r tg_ri}
set.seed(123)
