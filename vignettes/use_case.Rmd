...
such that closeness centrality would be an adequat candidate as an index. We here
use the pipelined approach of the `netrankr` package instead of the `closeness()`
...
We exclude the mathematical definitions. Refer to the literature for more details.
